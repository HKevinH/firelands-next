...
enum UnitFields {
  ...
  UNIT_FIELD_FACTIONTEMPLATE = OBJECT_END + 0x0029,
  UNIT_FIELD_DISPLAYID = OBJECT_END + 0x0035,
  UNIT_FIELD_FLAGS = OBJECT_END + 0x0038,
  UNIT_FIELD_FLAGS_2 = OBJECT_END + 0x0039,
  UNIT_FIELD_FLAGS_3 = OBJECT_END + 0x003A,
  UNIT_FIELD_FLAGS_4 = OBJECT_END + 0x003B,
  UNIT_FIELD_FLAGS_5 = OBJECT_END + 0x003C,
  UNIT_FIELD_FLAGS_6 = OBJECT_END + 0x003D,
