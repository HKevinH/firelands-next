...
-- spell_linked_spell seed data

INSERT INTO `spell_linked_spell` (spellTrigger, spellEffect, type, comment) VALUES
...
(45723,43313,2,'Target Indicator(duration),
(visual),
...
(66550,-66549,2,'Isle of Conquest Teleport (IN>OUT),
(66551,-66548,2,'Isle of Conquest Teleport (OUT>IN),
...
(66899,-66656,0,'On cast 66899 (Gunship Portal Click (to Hangar),
(Parachute),
